...
<section class="heading">
    <h3>pesanan Anda</h3>
    <p> <a href="home.php">home</a> / memesan </p>
</section>
...
<section class="placed-orders">
    ...
    <div class="box">
        ...
        <p> Status pembayaran : <span style="color:<?php if($fetch_orders['payment_status'] == 'tertunda'){echo 'tomato'; }else{echo 'green';} ?>"><?php echo $fetch_orders['payment_status']; ?></span> </p>
    </div>
    <?php
        }
    }else{
